...
class PriceListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price_list" do
    assert_difference('PriceList.count') do
      post price_lists_url, params: { price_list: { ingredient_id: @price_list.ingredient_id, price: @price_list.price, supplier_id: @price_list.supplier_id } }
    end
  ...
  test "should update price_list" do
    patch price_list_url(@price_list), params: { price_list: { ingredient_id: @price_list.ingredient_id, price: @price_list.price, supplier_id: @price_list.supplier_id } }
